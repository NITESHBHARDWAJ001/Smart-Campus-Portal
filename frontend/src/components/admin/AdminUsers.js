...
import { FaTrash, FaEdit, FaEye, FaFilter, FaSearch, FaUserPlus, FaUser } from 'react-icons/fa';
import AdminContext from '../../context/AdminContext';

const AdminUsers = () => {
  const { users, loading, error, pagination, getUsers, deleteUser, getUserById, user } = useContext(AdminContext);
        ...
        <Modal.Body>
          {profileLoading || !user ? (
            ...
            <div>
              ...
              {user.resumeLink && <p><strong>Resume:</strong> <a href={user.resumeLink} target="_blank" rel="noopener noreferrer">View Resume</a></p>}
