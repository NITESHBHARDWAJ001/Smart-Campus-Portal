...
export const PlacementProvider = ({ children }) => {
  ...
  const getPlacement = async (placementId) => {
    ...
    try {
      ...
      const res = await axios.get(`${API.placements.base}/${placementId}`);
  ...
  const updatePlacement = async (placementId, placementData) => {
    ...
    try {
      ...
      const res = await axios.put(`${API.placements.base}/${placementId}`, placementData);
  ...
  const deletePlacement = async (placementId) => {
    ...
    try {
      ...
      const res = await axios.delete(`${API.placements.base}/${placementId}`);
  ...
  const togglePlacementActive = async (placementId) => {
    ...
    try {
      ...
      const res = await axios.put(`${API.placements.base}/${placementId}/toggle-active`);
  ...
  const getPlacementApplications = async (placementId) => {
    ...
    try {
      ...
      const res = await axios.get(`${API.placements.base}/${placementId}/applications`);
      dispatch({
        type: 'GET_APPLICATIONS',
        payload: res.data.data // Only use the real data array
      });
  ...
  const getMyApplications = async () => {
    ...
    try {
      dispatch({ type: 'SET_LOADING' });
      // Always use real API in production
      const res = await axios.get(`${API.applications.base}/my-applications`);
      dispatch({
        type: 'GET_APPLICATIONS',
        payload: res.data.data // Only use the real data array
      });
  ...
  const applyForPlacement = async (applicationData) => {
    ...
    try {
      dispatch({ type: 'SET_LOADING' });
      // Always use real API, even in development
      const res = await axios.post(`${API.applications.base}`, applicationData);
      dispatch({
  ...
  const updateApplicationStatus = async (applicationId, status) => {
    ...
    try {
      ...
      const res = await axios.put(`${API.applications.base}/${applicationId}/status`, { status });
  ...
  const getApplication = async (applicationId) => {
    ...
    try {
      ...
      const res = await axios.get(`${API.applications.base}/${applicationId}`);
  ...
  const deleteApplication = async (applicationId) => {
    ...
    try {
      ...
      const res = await axios.delete(`${API.applications.base}/${applicationId}`);
